...
const styles = StyleSheet.create({
  ...
  questionDesc: { color: '#888', marginHorizontal: 16, marginBottom: 8 },
  ...
  complaintCard: { width: '30%', aspectRatio: 1, borderRadius: 16, alignItems: 'center', justifyContent: 'center', marginBottom: 12 },
  complaintIcon: { fontSize: 28, marginBottom: 6 },
  complaintLabel: { fontWeight: 'bold', fontSize: 14, textAlign: 'center' },
  popularTitle: { fontWeight: 'bold', fontSize: 16, marginHorizontal: 16, marginTop: 16 },
  popularList: { marginHorizontal: 16, marginTop: 8 },
  popularCard: { flexDirection: 'row', alignItems: 'center', borderRadius: 12, padding: 12, marginBottom: 8 },
  popularIcon: { fontSize: 22, marginRight: 12 },
  popularLabel: { fontWeight: '500', fontSize: 15 },
  continueBtn: { backgroundColor: '#00c97b', borderRadius: 20, margin: 24, paddingVertical: 16, alignItems: 'center', opacity: 1 },
